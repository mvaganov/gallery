...
public class Edge : MonoBehaviour {
	...
	public void Set(Node a, Node b){this.a=a;this.b=b;}
	...
	public void FixedUpdate() {
		...
		LineRenderer lr = Lines.Make (ref connectionLine, start, end, Color.white, a.settings.linesize, b.settings.linesize);
...
//		Debug.Log ("Creating edge "+(edgeCount++));
		GameObject go = null;
		LineRenderer lr = Lines.Make (ref go, a.transform.position, b.transform.position, a.settings.color, a.settings.linesize, b.settings.linesize);
		lr.numCapVertices = 3;
